...
export default function IntroductionSection({cutsRef}) {
  ...
  return (
    <section className='min-h-screen  bg-slate-800 w-full md:flex md:h-[100vh] pb-4 md:pb-0'>
      {/* Image Section */}
      ...
      <div className='flex justify-center items-center w-full md:w-1/2 md:h-full'>
        <div className="flex flex-col space-y-3 justify-center items-center md:items-start md:max-w-[380px] lg:max-w-[420px] xl:max-w-[560px] w-full">
          ...
          <button 
          class="group relative inline-flex items-center overflow-hidden rounded border-2 border-[#9DAED0] text-lg font-medium text-white hover:bg-gray-50 hover:text-white w-[45%] px-4 py-1 max-w-44"
          onClick={() => {
            if(cutsRef != null){
